                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                <form id="contact" method="POST" class="section contact" enctype="multipart/form-data">
                                    <div class="info">
                                        <h5 class="">General Button Settings</h5>
                                        <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control mb-4" id="button_text" placeholder="Button Text " value="<?php echo $button_text; ?>" name="button_text" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="button_url">Button Url *</label>
                                                            <input type="text" class="form-control mb-4" id="button_url" placeholder="Button Url" value="<?php echo $button_url; ?>" name="button_url" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea type="text" class="form-control mb-4" id="general_instruction_text" placeholder="Instruction Text" value="" name="general_instruction_text" required><?php echo $general_instruction_text; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control mb-4" id="survey_button_text" placeholder="Survey Button Text " value="<?php echo $survey_button_text; ?>" name="survey_button_text" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="survey_url">Survey Url *</label>
                                                            <input type="text" class="form-control mb-4" id="survey_url" placeholder="Survey Url" value="<?php echo $survey_url; ?>" name="survey_url" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea type="text" class="form-control mb-4" id="survey_instruction_text" placeholder="Instruction Text" value="" name="survey_instruction_text" required><?php echo $survey_instruction_text; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control mb-4" id="question_button_text" placeholder="Question Button" value="<?php echo $question_button_text; ?>" name="question_button_text" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="question_box_text">Question Box Text*</label>
                                                            <input type="text" class="form-control mb-4" id="question_box_text" placeholder="Question Box Text" value="<?php echo $question_box_text; ?>" name="question_box_text" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea type="text" class="form-control mb-4" id="question_instruction_text" placeholder="Instruction Text" value="" name="question_instruction_text" required><?php echo $question_instruction_text; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control mb-4" id="poll_button_text" placeholder="Poll Button Text" value="<?php echo $poll_button_text; ?>" name="poll_button_text" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea type="text" class="form-control mb-4" id="poll_instruction_text" placeholder="Instruction Text" value="" name="poll_instruction_text" required><?php echo $poll_instruction_text; ?></textarea>
                                                        </div>
                                                    </div>
