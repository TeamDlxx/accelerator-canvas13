...
if (isset($_POST['submit'])) {
    ...
    if (empty($error)) {
        ...
        $add_color_scheme_query = "INSERT INTO `color_scheme`(`title`, `website_footer_color`, `website_header_color`, `website_header_text`, `website_footer_text`, `login_box_color`, `login_box_text`, `button_text`, `button_color`, `link_color`, `back_top_button`, `header_menu_hover_color`, `color_scheme_status`) VALUES ('$scheme_title','$footer_background_color','$header_background_color','$header_menu_color','$footer_text','$login_box_color','$login_box_text','$button_text','$button_color','$link_color','$move_to_top_button','$header_menu_hover_color',$status)";
        $add_color_scheme_query_result = mysqli_query($connection_string, $add_color_scheme_query);
        if ($add_color_scheme_query_result) {
                ...
                <div class="page-header">
                    ...
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><span>Add Color Scheme</span></li>
                        </ol>
                    </nav>
                                        ...
                                        <div class="row">
                                            <div class="col-md-11 mx-auto">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="header_background_color">Header Backhroungd Color *</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="header_menu_hover_color">Header Menu Hover Color *</label>
