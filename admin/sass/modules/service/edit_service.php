...
$short_description = stripslashes($edit_service_info->short_description);
...
if (isset($_POST['submit'])) {
    ...
    if (($service_order <= '0') || ($service_order > $max_order)) {
        ...
        $error = "Service Description should not be empty";
    } else if (empty($service_image)) {
        $service_image = $old_service_image;
    }
    if ($error == "") {
        $service_image_dir = '../../../';
        $service_image_replace = str_replace(" ", "_", $_FILES['service_image']['name']);
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="file" class="form-control mb-4" id="service_image" placeholder="Last Name *" value="" name="service_image" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="detailed_description">Detailed
                                                                Description</label>
                                                            <textarea type="text" class="form-control mb-4" id="detailed_description" placeholder="Detailed Description" value="" name="detailed_description"><?php echo  $service_description; ?></textarea>
                                                        </div>
                                                    </div>
