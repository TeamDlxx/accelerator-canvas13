                                            ...
                                            <div class="col-md-11 mx-auto">
                                                <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="events" name="events">
                                                                <?php foreach ($event_list_result as $event_info) { ?>
                                                                    <option value="<?php echo $event_info['event_id']; ?>"><?php echo $event_info['title']; ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="free_access" name="free_access">
                                                                <option value="<?php echo $free_access; ?>">Active</option>
                                                                <option value="0">Non Active</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 text-right mb-5">
                                                        <a href="add_videos.php"><button id="add-work-platforms" name="submit" class="btn btn-primary">Add Video</button></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
