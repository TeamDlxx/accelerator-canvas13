...
if (isset($_POST['submit'])) {
    ...
    if (($testimonial_order <= '0') || ($testimonial_order > $max_order)) {
        ...
        $testimonial_image = $old_testimonial_image;
    }
    if ($error == "") {
        ...
        $update_testimonial_query = "UPDATE `testimonial` SET `testimonial_name`='$testimonial_name',`detailed_description`='$testimonial_description',`image`='$testimonial_image_name',`status`='$testimonial_status',`testimonial_order`='$testimonial_order' WHERE `testimonial_id`='$testimonial_id'";
