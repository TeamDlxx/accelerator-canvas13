                ...
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <div class="widget-content widget-content-area br-6">
                        <div class="col-md-12 text-right mb-5">
                            <a href="add_testimonial.php"><button id="add-work-platforms" class="btn btn-primary">Add
                                    New
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuReference1">
                                                            ...
                                                            <a class="dropdown-item" href="testimonials.php?testimonial_id=<?= $testimonial_data_values['testimonial_id']; ?>&action=delete" onclick="return confirm('Are you sure you want to delete the Testimonial?')">Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
