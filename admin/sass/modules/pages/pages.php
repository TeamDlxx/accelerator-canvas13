                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuReference1">
                                                            ...
                                                            <a class="dropdown-item" href="pages.php?page_id=<?php echo $pages_data_values['id']; ?>&action=delete" onclick="return confirm('Are you sure you want to delete this page?')">Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
