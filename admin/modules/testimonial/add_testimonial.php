...
$error = $success = $testimonial_description = $testimonial_name = $short_description =   "";
$status = 1;
// $testimonial_image ="";
...
if (isset($_POST['submit'])) {
    ...
    if (empty($error)) {
        ...
        $add_testimonial_query = "INSERT INTO `testimonial`(`testimonial_name`,`short_description`,`detailed_description`,`status`, `testimonial_order`) VALUES ('$testimonial_name','$short_description','$testimonial_description','$testimonial_status','$testimonial_order')";
