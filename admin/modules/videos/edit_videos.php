                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="file" class="form-control mb-4" id="image" required placeholder="" value="<?= $cover_thumbnail1 ?>" name="image">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="events" name="events">
                                                                <?php foreach ($event_list_result as $event_info) { ?>
                                                                    <option value="<?php echo $event_info['event_id']; ?>" <?php echo ($event_info['event_id'] == $event_id) ? "selected" : "" ?>>
