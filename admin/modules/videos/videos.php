...
if (isset($_GET['action']) && $_GET['action'] == "delete") {
    ...
    delete_video_order($connection_string, $del_order, $max_order);
                                    ...
                                    <?php if ($event_videos_data['status'] == 1) {
                                        ...
                                        foreach ($event_videos_data_result as $event_video_info) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo ($event_video_info['video_status'] == '1') ? "Active" : "InActive"; ?>
                                                </td>
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuReference1">
                                                            ...
                                                            <a class="dropdown-item" href="videos.php?event_video_id=<?= $event_video_info['id']; ?>&action=delete&del_order=<?= $event_video_info['video_order']; ?>" onclick="return confirm('Are you sure you want to delete Event Video?')">Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
