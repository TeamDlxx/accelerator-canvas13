                ...
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <div class="widget-content widget-content-area br-6">
                        <div class="col-md-12 text-right mb-5">
                            <a href="add_color_scheme.php"><button id="add-work-platforms" class="btn btn-primary">Add
                                    New
                                    ...
                                    <?php if ($webste_color_scheme['status'] == 1) {
                                        ...
                                        foreach ($website_color as $website_color_data) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo ($website_color_data['color_scheme_status'] == '1') ? "Active" : "InActive"; ?>
                                                </td>
                                                <td>
                                                    <div class="btn-group">
