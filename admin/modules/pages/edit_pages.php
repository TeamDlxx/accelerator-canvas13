...
if (isset($_POST['edit_page'])) {
    ...
    if ($error == "") {
        ...
        `image`='$new_image_name1',`image2`='$new_image_name2',`image3`='$new_image_name3',`image4`='$new_image_name4',
        `image5`='$new_image_name5',`show_menu`='$show_menu',`page_order`='$page_order' WHERE `id`='$page_id'";
                ...
                <div class="page-header">
                    ...
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><span>Edit Page</span></li>
                        </ol>
                    </nav>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control mb-4" id="page_order" placeholder="Page Order " value="<?php echo $old_page_order; ?>" name="page_order">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
