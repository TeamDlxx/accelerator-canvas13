...
if (isset($_POST['submit'])) {
    ...
    $email_address_exist = email_exist($connection_string, $user_email);
    ...
    } else if ($email_address_exist == false and $old_email != $user_email) {
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                <form id="contact" method="POST" class="section contact" enctype="multipart/form-data">
                                    ...
                                    <div class="info">
                                        <h5 class="" style="padding-left: 35px;">Edit User</h5>
                                        <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control mb-4" id="Phone Number" required placeholder="Phone Number" value="<?php echo $phone_number; ?>" name="phone_number" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
