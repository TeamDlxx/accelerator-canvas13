...
if (isset($_POST['submit'])) {
    ...
    if ($error == "") {
        ...
        // echo count($name);
        // die
        $insert_poll_query = "INSERT INTO `pool_question`(`pool_question`, `pool_status`, `event_id`, `pool_type`, `video_id`) VALUES ('" . $poll_question . "', '" . $poll_status . "', '" . $event_id . "', '" . $poll_type . "', '" . $video_id . "')";
        $insert_poll_query_result = mysqli_query($connection_string, $insert_poll_query);
        if ($insert_poll_query_result) {
            //form POST check IF ends here
            $query = "SELECT * FROM `pool_question` ORDER BY pool_id DESC";
            $result = mysqli_query($connection_string, $query);
            $array = mysqli_fetch_array($result);
            $poll_id = $array['pool_id'];
            ...
            if ($number > 1) {
                for ($i = 0; $i < $number; $i++) {
                    ...
                    if (trim($_POST["name"][$i] != '')) {
                        ...
                        $sql_result =  mysqli_query($connection_string, $sql);
                        if ($sql_result) {
                ...
                $error =  "Please Enter more options";
            }
        } else {
            $error = $error_support;
        }
...
$events = get_event_info($connection_string);
                ...
                <div class="page-header">
                    ...
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><span>Add Poll</span></li>
                        </ol>
                    </nav>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control mb-4" id="poll_question" placeholder="Poll Question" value="" name="poll_question" required>
...
"><?php echo $videos['video_title']; ?></option>
                                                ...
                                                <div class="row" id="dynamic_field">
                                                    <?php if (sizeof($name) > 0) {

                                                        foreach ($name as $option_values) {
                                                    ?>
                                                            <div class="col-sm-6 col-md-6 col-xs-12">
                                                                ...
                                                                <div class="item form-group">
                                                                    <div class="col-12" id="dynamic_field_even" style="padding-left:0; padding-right:0;">
                                                                        <input type="text" name="name[]" value="<?php echo $option_values; ?>" placeholder="Add More Options" class="form-control name_list" />
            ...
            $(document).ready(function() {
                ...
                $('#add').click(function() {
                    ...
                    $('#dynamic_field').append(
                        `<div class = "col-md-6"><label>Option ${i}*</label><br>
                            <input type='text' name='name[]' id='option-${i}' required placeholder='option ${i}' class='form-control name_list'style="margin-bottom: 10px;" /></div>`
                    );
