                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuReference1">
                                                        <a class="dropdown-item" href="delete_option.php?option_id=<?= $delete_answer['id']; ?>&action=delete&poll_id=<?= $poll_id; ?>" onClick="return confirm('Are you sure you want to delete this option?')">Delete
                                                            Option
                                                        </a>
                                                    </div>
                                                </div>
