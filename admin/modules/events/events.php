                                    ...
                                    <?php if ($events_result['status'] == 1) {
                                        ...
                                        foreach ($events_result_data as $events_data_values) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo date('d/m/Y', strtotime($events_data_values['start_date_time'])); ?>
                                                </td>
                                                <td><?php echo date('d/m/Y', strtotime($events_data_values['end_date_time'])); ?>
                                                </td>
                                                <td><?php echo ($events_data_values['status'] == '1') ? "Active" : "InActive"; ?>
                                                </td>
                                                <td>
                                                    <div class="btn-group">
