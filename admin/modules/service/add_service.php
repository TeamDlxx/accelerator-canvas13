...
$error = $success = $services_description = $services_name = $short_description = $services_name = $services_description = $services_image = $services_image_name = "";
$status = 1;
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="services_name">Service Title *</label>
                                                            <input type="text" class="form-control mb-4" id="services_name" placeholder="Service Name " value="<?php echo $services_name; ?>" name="services_name">

                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="services_image">Service Image Recomended Size (72x72)</label>
                                                            <input type="file" class="form-control mb-4" id="services_image" placeholder="Last Name " value="<?php echo $services_image_name; ?>" name="services_image">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea type="text" class="form-control mb-4" id="short_description" placeholder="Short Description" value="" name="short_description"><?php echo $short_description; ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="description">Detailed Description</label>
                                                            <textarea type="text" class="form-control mb-4" id="description" placeholder="Detailed Description" value="" name="description"><?php echo $services_description; ?></textarea>
                                                        </div>
                                                    </div>
