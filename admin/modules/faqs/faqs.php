...
if (isset($_GET['action']) and $_GET['action'] == 'delete') {
    ...
    delete_faq_order($connection_string, $del_order, $max_order);
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuReference1">
                                                            <a class="dropdown-item" href="faqs.php?faq_id=<?= $user_value['faq_id']; ?>&action=delete&del_order=<?= $user_value['faq_order']; ?>" onclick="return confirm('Are you sure you want to delete the Faq?')">Delete</a>
