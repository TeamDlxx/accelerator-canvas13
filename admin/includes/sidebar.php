...
<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            <li class="menu">
                <a href="<?= $base_url_admin ?>modules/dashboard/dashboard.php" class="dropdown-toggle" <?php if ($active_menu == "dashboard") { ?>data-active="true" <?php } ?>>
                    <div class="">
            ...
            <li class="menu">
                <a href="<?= $base_url_admin ?>modules/settings/slider_setting.php" class="dropdown-toggle" <?php if ($active_menu == "slider") { ?>data-active="true" <?php } ?>>
                    <div class="">
                        <!-- <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home">
                            <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                            <polyline points="9 22 9 12 15 12 15 22"></polyline>
            ...
            <li class="menu">
                <a href="<?= $base_url_admin ?>modules/settings/home_content.php" class="dropdown-toggle" <?php if ($active_menu == "home_content") { ?>data-active="true" <?php } ?>>
                    <div class="">
            ...
            <li class="menu">
                <a href="<?= $base_url_admin ?>modules/settings/general_settings.php" class="dropdown-toggle" <?php if ($active_menu == "general_settings") { ?>data-active="true" <?php } ?>>
                    <div class="">
            ...
            <li class="menu">
                <a href="<?= $base_url_admin ?>modules/settings/facebook_pixel.php" class="dropdown-toggle" <?php if ($active_menu == "facebook") { ?>data-active="true" <?php } ?>>
                    <div class="">
            ...
            <li class="menu">
                <a href="<?= $base_url_admin ?>modules/settings/google_analytics.php" class="dropdown-toggle" <?php if ($active_menu == "google") { ?>data-active="true" <?php } ?>>
                    <div class="">
            ...
            <li class="menu">
                <a href="<?= $base_url_admin ?>modules/settings/active_compaign.php" class="dropdown-toggle" <?php if ($active_menu == "campaign") { ?>data-active="true" <?php } ?>>
                    <div class="">
            ...
            <li class="menu">
                <a href="<?= $base_url_admin ?>modules/user/user_list.php" class="dropdown-toggle" <?php if ($active_menu == "subcribers") { ?> data-active="true" <?php }  ?>>
            ...
            <!-- <li class="menu">
                <a href="<?= $base_url_admin ?>modules/events/events.php" class="dropdown-toggle" <?php if ($active_menu == "events") { ?> data-active="true" <?php }  ?>>
                    <div class="">
            ...
            <!-- <li class="menu">
                <a href="<?= $base_url_admin ?>modules/faqs/faqs.php" class="dropdown-toggle" <?php if ($active_menu == "FAQs") { ?> data-active="true" <?php }  ?>>
                    <div class="">
            ...
            <!-- <li class="menu">
                <a href="<?= $base_url_admin ?>modules/testimonial/testimonials.php" class="dropdown-toggle" <?php if ($active_menu == "testimonial") { ?> data-active="true" <?php }  ?>>
                    <div class="w-icon">
            ...
            <!-- <li class="menu">
                <a href="<?= $base_url_admin ?>modules/clients/clients.php" class="dropdown-toggle" <?php if ($active_menu == "clients") { ?> data-active="true" <?php }  ?>>
                    <div class="w-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users">
                            <path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71">
                            </path>
            ...
            <li class="menu">
                <a href="<?= $base_url_admin ?>modules/service/service.php" class="dropdown-toggle" <?php if ($active_menu == "service") { ?> data-active="true" <?php }  ?>>
                    <div class="">
            ...
            <!-- <li class="menu">
                <a href="<?= $base_url_admin ?>modules/questions/questions.php" class="dropdown-toggle" <?php if ($active_menu == "questions") { ?> data-active="true" <?php }  ?>>
                    <div class="">
            ...
            <li class="menu">
                <a href="<?= $base_url_admin ?>modules/menu/edit_menu.php?menu_id=23" class="dropdown-toggle" <?php if ($active_menu == "menu") { ?> data-active="true" <?php }  ?>>
                    <div class="">
            ...
            <li class="menu">
                <a href="<?= $base_url_admin ?>modules/support_ticket/support_tickets.php" class="dropdown-toggle" <?php if ($active_menu == "support_tickets") { ?> data-active="true" <?php }  ?>>
                    <div class="">
                        <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="calendar-minus" class="svg-inline--fa fa-calendar-minus fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                            <path fill="currentColor" d="M124 328c-6.6 0-12-5.4-12-12v-24c0-6.6 5.4-12 12-12h200c6.6 0 12 5.4 12 12v24c0 6.6-5.4 12-12 12H124zm324-216v352c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V112c0-26.5 21.5-48 48-48h48V12c0-6.6 5.4-12 12-12h40c6.6 0 12 5.4 12 12v52h128V12c0-6.6 5.4-12 12-12h40c6.6 0 12 5.4 12 12v52h48c26.5 0 48 21.5 48 48zm-48 346V160H48v298c0 3.3 2.7 6 6 6h340c3.3 0 6-2.7 6-6z"></path>
                        </svg>
                        <span style="font-weight: 500;">Support Ticket <?php if ($notification_count > 0) { ?> <span class="ml-1 text-danger">(<?php echo $notification_count; ?>)</span><?php } ?></span>
                    </div>
                </a>
            </li>
            <li class="menu">
                <a href="<?= $base_url_admin ?>modules/help_videos/help_videos.php" class="dropdown-toggle" <?php if ($active_menu == "help_videos") { ?> data-active="true" <?php }  ?>>
                    <div class="">
                        <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="calendar-minus" class="svg-inline--fa fa-calendar-minus fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                            <path fill="currentColor" d="M124 328c-6.6 0-12-5.4-12-12v-24c0-6.6 5.4-12 12-12h200c6.6 0 12 5.4 12 12v24c0 6.6-5.4 12-12 12H124zm324-216v352c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V112c0-26.5 21.5-48 48-48h48V12c0-6.6 5.4-12 12-12h40c6.6 0 12 5.4 12 12v52h128V12c0-6.6 5.4-12 12-12h40c6.6 0 12 5.4 12 12v52h48c26.5 0 48 21.5 48 48zm-48 346V160H48v298c0 3.3 2.7 6 6 6h340c3.3 0 6-2.7 6-6z"></path>
                        </svg>
            ...
            <!-- <li class="menu">
                <a href="<?= $base_url_admin ?>modules/videos/videos.php" class="dropdown-toggle" <?php if ($active_menu == "video") { ?> data-active="true" <?php }  ?>>
                    <div class="">
            ...
            <!-- <li class="menu">
                <a href="<?= $base_url_admin ?>modules/poll/poll.php" class="dropdown-toggle" <?php if ($active_menu == "poll") { ?> data-active="true" <?php }  ?>>
                    <div class="">
            ...
            <!-- <li class="menu">
                <a href="<?= $base_url_admin ?>modules/catagory/catagories.php" class="dropdown-toggle" <?php if ($active_menu == "catagory") { ?> data-active="true" <?php }  ?>>
                    <div class="">
                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="poll" class="svg-inline--fa fa-poll fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                            <path fill="currentColor" d="M400 32H48C21.5 32 0 53.5 0 80v352c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V80c0-26.5-21.5-48-48-48zM160 368c0 8.84-7.16 16-16 16h-32c-8.84 0-16-7.16-16-16V240c0-8.84 7.16-16 16-16h32c8.84 0 16 7.16 16 16v128zm96 0c0 8.84-7.16 16-16 16h-32c-8.84 0-16-7.16-16-16V144c0-8.84 7.16-16 16-16h32c8.84 0 16 7.16 16 16v224zm96 0c0 8.84-7.16 16-16 16h-32c-8.84 0-16-7.16-16-16v-64c0-8.84 7.16-16 16-16h32c8.84 0 16 7.16 16 16v64z"></path>
                        </svg>
            ...
            <!-- <li class="menu">
                <a href="<?= $base_url_admin ?>modules/product/products.php" class="dropdown-toggle" <?php if ($active_menu == "catagory") { ?> data-active="true" <?php }  ?>>
                    <div class="">
                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="poll" class="svg-inline--fa fa-poll fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                            <path fill="currentColor" d="M400 32H48C21.5 32 0 53.5 0 80v352c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V80c0-26.5-21.5-48-48-48zM160 368c0 8.84-7.16 16-16 16h-32c-8.84 0-16-7.16-16-16V240c0-8.84 7.16-16 16-16h32c8.84 0 16 7.16 16 16v128zm96 0c0 8.84-7.16 16-16 16h-32c-8.84 0-16-7.16-16-16V144c0-8.84 7.16-16 16-16h32c8.84 0 16 7.16 16 16v224zm96 0c0 8.84-7.16 16-16 16h-32c-8.84 0-16-7.16-16-16v-64c0-8.84 7.16-16 16-16h32c8.84 0 16 7.16 16 16v64z"></path>
                        </svg>
            ...
            <!-- <li class="menu">
                <a href="<?= $base_url_admin ?>modules/pages/pages.php" class="dropdown-toggle" <?php if ($active_menu == "pages") { ?> data-active="true" <?php }  ?>>
                    <div class="">
            ...
            <!-- <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="app" data-parent="#accordionExample">
                    <li>
                        <a href="<?= $base_url_admin ?>modules/settings/change_password.php" <?php if ($active_menu == "setting") { ?> data-active="true" <?php }  ?>> Change Password
                        </a>
                    </li>
                </ul>
                <ul class="collapse submenu list-unstyled" id="app" data-parent="#accordionExample">
                    <li>
                        <a href="<?= $base_url_admin ?>modules/settings/change_email.php" <?php if ($active_menu == "setting") { ?> data-active="true" <?php }  ?>> Change Email </a>
                    </li>
                </ul>
                <ul class="collapse submenu list-unstyled" id="app" data-parent="#accordionExample">
                    <li>
                        <a href="<?= $base_url_admin ?>modules/settings/slider_setting.php"> Slider Settings </a>
                    </li>
                </ul>
                <ul class="collapse submenu list-unstyled" id="app" data-parent="#accordionExample">
                    <li>
                        <a href="<?= $base_url_admin ?>modules/settings/home_content.php">Home Content </a>
                    </li>
                </ul>
                <ul class="collapse submenu list-unstyled" id="app" data-parent="#accordionExample">
                    <li>
                        <a href="<?= $base_url_admin ?>modules/settings/sidebar_settings.php">Sidebar Settings </a>
                    </li>
                </ul>
                <ul class="collapse submenu list-unstyled" id="app" data-parent="#accordionExample">
                    <li>
                        <a href="<?= $base_url_admin ?>modules/settings/general_settings.php">General Settings </a>
                    </li>
                </ul>
                <ul class="collapse submenu list-unstyled" id="app" data-parent="#accordionExample">
                    <li>
                        <a href="<?= $base_url_admin ?>modules/settings/website_color.php">Web Site Color </a>
                    </li>
                </ul>
            </li> -->
        </ul>
